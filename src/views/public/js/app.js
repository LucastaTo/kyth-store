...
(function () {
    ...
    function setLanguage(lang) {
        document.getElementsByClassName("header-lang-img").forEach(function (el) {
            if (el) {
                switch (lang) {
                    case "eng":
                        el.src = "/images/flags/us.jpg";
                        break;
                    case "sp":
                        el.src = "/images/flags/spain.jpg";
                        break;
                    case "gr":
                        el.src = "/images/flags/germany.jpg";
                        break;
                    case "it":
                        el.src = "/images/flags/italy.jpg";
                        break;
                    case "ru":
                        el.src = "/images/flags/russia.jpg";
                        break;
                    default:
                        el.src = "/images/flags/us.jpg";
                        break;
    ...
    function changeDirection(id) {
        if (document.getElementById("layout-direction-ltr").checked == true && id === "layout-direction-ltr") {
            ...
            document.getElementById('bootstrap-style').setAttribute('href', '/css/bootstrap.min.css');
            document.getElementById('app-style').setAttribute('href', '/css/app.min.css');
            sessionStorage.setItem("is_visited", "layout-direction-ltr");
            ...
            document.getElementById('bootstrap-style').setAttribute('href', '/css/bootstrap-rtl.min.css');
            document.getElementById('app-style').setAttribute('href', '/css/app-rtl.min.css');
